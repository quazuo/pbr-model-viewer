...
namespace mix_
{
	...
	entry<glm::vec3, bool> const Testglm::vec3Bool[] =
	{
	...
	entry<glm::vec3, glm::bvec3> const TestBglm::vec3[] =
	{
	...
	static int test()
	{
		...
		// vec3 with bool
		{
			for(std::size_t i = 0; i < sizeof(Testglm::vec3Bool) / sizeof(entry<glm::vec3, bool>); ++i)
			{
				glm::vec3 Result = glm::mix(Testglm::vec3Bool[i].x, Testglm::vec3Bool[i].y, Testglm::vec3Bool[i].a);
				Error += glm::equal(Result.x, Testglm::vec3Bool[i].Result.x, glm::epsilon<float>()) ? 0 : 1;
				Error += glm::equal(Result.y, Testglm::vec3Bool[i].Result.y, glm::epsilon<float>()) ? 0 : 1;
				Error += glm::equal(Result.z, Testglm::vec3Bool[i].Result.z, glm::epsilon<float>()) ? 0 : 1;
			}
		}

		// vec3 with bvec3
		{
			for(std::size_t i = 0; i < sizeof(TestBglm::vec3) / sizeof(entry<glm::vec3, glm::bvec3>); ++i)
			{
				glm::vec3 Result = glm::mix(TestBglm::vec3[i].x, TestBglm::vec3[i].y, TestBglm::vec3[i].a);
				Error += glm::equal(Result.x, TestBglm::vec3[i].Result.x, glm::epsilon<float>()) ? 0 : 1;
				Error += glm::equal(Result.y, TestBglm::vec3[i].Result.y, glm::epsilon<float>()) ? 0 : 1;
				Error += glm::equal(Result.z, TestBglm::vec3[i].Result.z, glm::epsilon<float>()) ? 0 : 1;
			}
		}
